...
class FlAliYunNumberAuthPlugin : FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {
    ...
    private fun setAuthUI(call: MethodCall, result: Result) {
        ...
        if (statusBarUi != null) {
            (statusBarUi["statusBarColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setStatusBarColor(it.toColor())
            }
            ...
            (statusBarUi["webViewStatusBarColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setWebViewStatusBarColor(it.toColor())
            }
        }
        val navUi = args["navUi"] as Map<*, *>?
        if (navUi != null) {
            (navUi["navColor"] as Map<*, *>?)?.let { authUIConfigBuilder.setNavColor(it.toColor()) }
            (navUi["navText"] as String?)?.let { authUIConfigBuilder.setNavText(it) }
            (navUi["navTextColor"] as Map<*, *>?)?.let { authUIConfigBuilder.setNavTextColor(it.toColor()) }
            ...
            (navUi["webNavColor"] as Map<*, *>?)?.let { authUIConfigBuilder.setWebNavColor(it.toColor()) }
            (navUi["webNavTextColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setWebNavTextColor(it.toColor())
            }
            ...
            (navUi["webViewStatusBarColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setWebViewStatusBarColor(it.toColor())
            }
            ...
            (navUi["bottomNavColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setBottomNavColor(
                    it.toColor()
                )
            }
        ...
        if (sloganUi != null) {
            ...
            (sloganUi["sloganTextColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setSloganTextColor(it.toColor())
            }
        ...
        if (numberUi != null) {
            (numberUi["numberColor"] as Map<*, *>?)?.let { authUIConfigBuilder.setNumberColor(it.toColor()) }
        ...
        if (loginBtnUi != null) {
            ...
            (loginBtnUi["logBtnTextColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setLogBtnTextColor(it.toColor())
            }
        ...
        if (privacyUi != null) {
            ...
            (privacyUi["privacyColor"] as Map<*, *>?)?.let { color ->
                (privacyUi["privacyUrlColor"] as Map<*, *>?)?.let { urlColor ->
                    authUIConfigBuilder.setAppPrivacyColor(
                        color.toColor(), urlColor.toColor()
                    )
                }
            }
            ...
            (privacyUi["privacyOneColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyOneColor(it.toColor())
            }
            (privacyUi["privacyTwoColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyTwoColor(it.toColor())
            }
            (privacyUi["privacyThreeColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyThreeColor(it.toColor())
            }
            (privacyUi["privacyOperatorColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyOperatorColor(it.toColor())
            }
        ...
        if (switchUi != null) {
            ...
            (switchUi["switchAccTextColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setSwitchAccTextColor(it.toColor())
            }
        ...
        if (privacyAlertUi != null) {
            ...
            (privacyAlertUi["privacyAlertBackgroundColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertBackgroundColor(it.toColor())
            }
            ...
            (privacyAlertUi["privacyAlertTitleBackgroundColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertTitleBackgroundColor(it.toColor())
            }
            ...
            (privacyAlertUi["privacyAlertTitleColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertTitleColor(it.toColor())
            }
            (privacyAlertUi["privacyAlertContentBackgroundColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertContentBackgroundColor(it.toColor())
            }
            ...
            (privacyAlertUi["privacyAlertContentColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertContentColor(it.toColor())
            }
            (privacyAlertUi["privacyAlertContentBaseColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertContentBaseColor(it.toColor())
            }
            ...
            (privacyAlertUi["privacyAlertBtnTextColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertBtnTextColor(it.toColor())
            }
            ...
            (privacyAlertUi["privacyAlertOneColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertOneColor(it.toColor())
            }
            (privacyAlertUi["privacyAlertTwoColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertTwoColor(it.toColor())
            }
            (privacyAlertUi["privacyAlertThreeColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertThreeColor(it.toColor())
            }
            (privacyAlertUi["privacyAlertOperatorColor"] as Map<*, *>?)?.let {
                authUIConfigBuilder.setPrivacyAlertOperatorColor(it.toColor())
            }
        }
