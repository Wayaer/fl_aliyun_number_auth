...
class PrivacyUIModelForAndroid {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'privacyUrlColor': privacyUrlColor?.toMap(),
        ...
        'privacyOneColor': privacyOneColor?.toMap(),
        'privacyTwoColor': privacyTwoColor?.toMap(),
        'privacyThreeColor': privacyThreeColor?.toMap(),
        'privacyOperatorColor': privacyOperatorColor?.toMap(),
...
class PrivacyUIModelForIOS {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'privacyTwo': privacyTwo?.toMap(),
        'privacyThree': privacyThree?.toMap(),
        'privacyColors': privacyColors?.map((e) => e.toMap()).toList(),
